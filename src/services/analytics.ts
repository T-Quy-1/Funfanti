...
export const analyticsEvents = {
  ...
  question_sets_filter_open: "question_sets_filter_open",
  question_sets_filter_apply: "question_sets_filter_apply",
  question_sets_filter_reset: "question_sets_filter_reset",
  question_sets_filter_tag_toggle: "question_sets_filter_tag_toggle",
  question_sets_filter_range_toggle: "question_sets_filter_range_toggle",
  question_sets_filter_sort_toggle: "question_sets_filter_sort_toggle",
  ...
  lockscreen_notification_action: "lockscreen_notification_action",
  lockscreen_quick_question_answer: "lockscreen_quick_question_answer",
  lockscreen_quick_question_close: "lockscreen_quick_question_close",
  lockscreen_timing_save: "lockscreen_timing_save",
  api_error: "api_error",
